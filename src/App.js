...
//view 
  ...
  return (
    <>
    <Carrd imageLink={"https://t3.gstatic.com/licensed-image?q=tbn:ANd9GcQBOyAeOot-s1ukUGW6iVmN4UlGBcWx1fd_5_PdxgOiticKByaWNg44t9Wwyh5u5WMg"} title={"김우빈짱"} subTitle={"이것은 김우빈 사진입니다."}/>
    <Carrd imageLink={"https://img.hankyung.com/photo/202405/01.36878930.1.jpg"} title={"변우석"} subText={"다음은 변우석 사진입니다."}/>
